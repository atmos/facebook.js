...
(function($){
    ...
    FB_RequireFeatures(["Connect", "Api"], function() {
      FB.Connect.requireSession(function () {
        $.fbProfile(options['include'], function (profile) {
          $.post(fbOptions['sessionSyncAction'] || "/facebook/session", profile, function (fbSession) {
            if (fbSession['userId']) {
              authenticated = true;
  ...
  $.fbLogout = function (callback) {
    FB.Connect.logout(function () {
       $.get(fbOptions['sessionSyncAction'] || "/facebook/logout", {}, function () {
         callback();
       }, 'json');
    });
  };
  ...
  $.fbIsAuthenticated = function (authenticated_callback, not_authenticated_callback) {
    if(authenticated === null) {
      $.get(fbOptions['sessionSyncAction'] || '/facebook/session', {}, function (fbSession) {
        if (fbSession['userId']) {
          authenticated = true;
          authenticatedFbSession = fbSession;
